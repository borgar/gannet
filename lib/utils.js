...
function Coocon ( str ) { this.value = str; }
Coocon.prototype = new String;
Coocon.prototype.valueOf = function () { return this.value; };
...
exports.rollup_with_values = function ( collection, list, object ) {
  ...
  list.forEach(function ( item ) {
    ...
    if ( key in collection ) {
      collection[ key ].push( object || item );
    }
    else {
      group = { 'items': [ object || item ], 'id': key };
